...
2 rem
4 rem youtube: https://www.youtube.com/watch?v=dASqLXiuomY
5 rem
300 'Axel:
...
710 FOR u=1 TO 200:NEXT
720 SOUND 1,10,5,n,0,0,5:n=n-1
730 FOR u=1 TO 200:NEXT
740 NEXT:RETURN
...
810 FOR x=1 TO z:NEXT
820 z=z-10    
830 NEXT n,u:RETURN  
840 q$=INKEY$:IF q$="" THEN RETURN ELSE RUN
*/ });
