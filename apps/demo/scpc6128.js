...
1290 DATA 999,0,0,0
1530 t=TIME:WHILE TIME-t<1200:call &bd19:WEND
...
1550 IF TIME-t<900 THEN call &bd19:goto 1550 ELSE 1560
...
1650 T=TIME
1660 IF TIME-T<2100 THEN call &bd19:goto 1660
...
1760 st=1
1770 t=TIME
1780 IF TIME-t<900 THEN call &bd19:goto 1780
...
1880 IF f=0 THEN call &bd19:goto 1880 ELSE 1882
...
2240 IF TIME-t<900 THEN call &bd19:goto 2240
...
3630 RETURN
3640 T=TIME
3650 IF TIME-T<1000 THEN call &bd19:goto 3650
3660 'spreadsheet
3665 GOSUB 10000
...
3680 T=TIME
3690 IF TIME-T<900 THEN call &bd19:goto 3690
...
3720 T=TIME
3730 IF TIME-t<900 THEN call &bd19:goto 3730
3740 MODE 2
...
4620 GOTO 4530
4630 T=TIME
4640 IF TIME-T<1500 THEN call &bd19:goto 4640 ELSE 4700
...
4720 IF TIME-t<900 THEN call &bd19:goto 4720
...
5170 GOSUB 5200
5180 T=TIME
5190 IF TIME-T<300 THEN call &bd19:goto 5190 ELSE 5650
...
5690 IF I<2000 THEN call &bd19:goto 5670
...
6160 NEXT point
6170 '
6180 t=TIME:WHILE t+200>TIME:call &bd19:WEND
6190 FOR s=4 TO 2 STEP-1
6192 FOR i=0 TO 13:INK i,0:NEXT:FRAME:CALL mcentry,s
6194 FOR i=0 TO 13:INK i,i*2:NEXT
6200 t=TIME:WHILE t+400>TIME:call &bd19:WEND
6210 NEXT s
6220 t=TIME:WHILE t+400>TIME:call &bd19:WEND
6230 RETURN
6240 '
6260 MOVE 0,big\2,i
