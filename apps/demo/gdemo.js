...
380 INK 1,26:INK 1,0:INK 2,26:INK 2,0
390 INK 3,26:INK 3,0:GOTO 380
400 '
...
590 CALL &BD19:INK 10,0:NEXT t:GOTO 580
600 '
610 MEMORY 8999:RESTORE 620:FOR a=9000 TO 9060:READ b:POKE a,b:NEXT
...
630 MODE 1:INK 0,0:BORDER 0:INK 1,6:FOR a=0 TO 640 STEP 20:PLOT a,0:DRAW 0,320-a:PLOT a,400:DRAW 0,a:PLOT 640-a,0:DRAW 640,320-a:PLOT 640-a,400:DRAW 640,a:PLOT 0,a:DRAW 320,200:DRAW 640,a:PLOT a,0:DRAW 320,200:DRAW a,400:NEXT:CALL 9000:POKE 9008,101:CLS  
640 INK 2,2:FOR a=0 TO 640 STEP 12:PLOT a,0,2:DRAWR 0,400:DRAW 640 -a,0:PLOT 0,a:DRAWR 640,0:DRAW 0,400-a:NEXT:CALL 9000
650 DIM d(39):FOR a=0 TO 7:FOR b=0 TO 4:d(a*5+b)=9500+a*10+B*400:NEXT B,A
660 FOR P=0 TO 1:FOR A=39 TO 1 STEP -1:FOR B=0 TO 39:CALL 9012,D(B)+39652,D(B)+P*16384:NEXT:FOR B=0 TO 39 STEP A:IF B>0 OR A<10 THEN CALL 9012,D(B)+39652,D(B)-(P-1)*16384
670 NEXT B,A,P:INK 1,RND*26+1:INK 2,RND*26+1:GOTO 660
680 'Grafik 3
690 MEMORY 26174:RESTORE 310:FOR a=26175 TO 26235:READ b:POKE a,b:NEXT:INK 0,2:BORDER 1
...
710 NEXT b,a:CALL 26175:PAPER 3:CLS
720 LOCATE 1,9:PRINT"Sicht von  oben     /    unten":DIM d(39):FOR a=0 TO 7:FOR b=0 TO 4:d(a*5+b)=26236+a*10+b*400:NEXT b,a
730 FOR c=0 TO 39 STEP 4:FOR a=0 TO 39-c:GOSUB 740:NEXT:FOR a=39-c TO 0 STEP -1:GOSUB 740:NEXT a,c:FOR b=0 TO 2000:NEXT:GOTO 730
740 CALL &BD19:CALL 26187,49972,d(a):CALL 26187,50002,d(39-a):FOR b=0 TO 10:NEXT:RETURN
750 '
760 'Grafik 4
770 MEMORY 26174:RESTORE 310:FOR a=26175 TO 26235:READ b:POKE a,b:NEXT
...
810 CALL 26187,49552,49152:p=0:FOR a=0 TO 580 STEP 80:FOR b=240 TO 0 STEP -80:FOR c=0 TO 49
820 IF b>0 OR a<560 THEN x=INT(RND*80)+1:y=INT(RND*80)+1:IF TEST(x+160,y+320)=1 THEN 820 ELSE PLOT x+160,y+320,1:PLOT a+x,b+y,TEST(x+80,y+320):NEXT:CALL 26187,d(p+1)+22916,d(p)+22916:p=p+1
830 NEXT b,a:CALL 26175:CLS
840 CALL 26187,49982,26236:CALL 26187,49992,26246:FOR b=0 TO 2000:NEXT:FOR a=0 TO 31:CALL &BD19:CALL 26187,49982,d(a):CALL 26187,49992,d(31-a):NEXT a:CALL 26187,49982,26246:CALL 26187,49992,26236:FOR b=0 TO 2000:NEXT:GOTO 840
850 'Men
860 MEMORY 26174:RESTORE 310:FOR a=26175 TO 26235:READ b:POKE a,b:NEXT:INK 0,26:BORDER 26
...
890 PLOT 38,40:DRAWR 0,32:TAG:PLOT 34,78:PRINT CHR$(225);:TAGOFF:PLOT 38,60,1:DRAWR SIN(a)*16,COS(a)*16:DRAWR SIN(c+180)*16,COS(c+180)*16:PLOT 38,60,2:DRAWR SIN(b*16),COS(b*16):DRAWR SIN(d+180)*16,COS(d+180)*16:CALL 26187,d(z)+22916,d(39)+22916
900 z=z+1:NEXT:CALL 26175:CLS
910 FOR a=0 TO 39:GOSUB 920:NEXT:FOR a=39 TO 0 STEP -1:GOSUB 920:NEXT:GOTO 910
920 FOR b=0 TO 20 STEP 10:CALL 26187,50782+b-z,d(a):NEXT:z=z+0.4+1630*(z>1630):RETURN
930 'Blinker
...
980 x=INT(RND*26)+1:FOR a=1 TO 15:INK a,x:CALL &BD19:INK a,27-x:NEXT:GOTO 980
990 'Herz
...
1030 FOR a=1 TO 14:INK a,6:CALL &BD19:INK a,0:NEXT:FOR a=14 TO 1 STEP -1:INK a,0:CALL &BD19:INK a,6:NEXT:GOTO 1030
1040 'Wirbel
...
1080 FOR b=0 TO 50:FOR a=1 TO 13:INK a,26:CALL &BD19:INK a,0:NEXT a,b:FOR b=0 TO 50:FOR a=13 TO 1 STEP -1:INK a,26:CALL &BD19:INK a,0:NEXT a,b:GOTO 1080 
1090 'Pac-Man
...
1130 NEXT:FOR c=0 TO PI STEP 0.1:x=SIN(c)*8:PLOT x+60,COS(c)*12+100,0:DRAWR -2*x,0:NEXT:d=d+0.15:FOR e=0.6+d TO 3-d STEP 0.012:PLOT 80,80:DRAWR SIN(e)*60,COS(e)*60:NEXT:NEXT a,b:CALL 26175:CLS
1140 DIM d(7):FOR a=0 TO 1:FOR b=0 TO 3:d(a*4+b)=26236+a*800+b*20:NEXT b,a:z=0
1150 FOR a=0 TO 7:GOSUB 1160:NEXT:FOR a=7 TO 0 STEP -1:GOSUB 1160:NEXT:GOTO 1150
1160 CALL 26187,49152+z,d(a):CALL &BD19:CALL &BD19:z=z+1+1000*(z=999):RETURN
1170 ' r2-d2
