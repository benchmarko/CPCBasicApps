...
820 IF b>0 OR a<560 THEN x=INT(RND*80)+1:y=INT(RND*80)+1:IF TEST(x+160,y+320)=1 THEN 820 ELSE PLOT x+160,y+320,1:PLOT a+x,b+y,TEST(x+80,y+320):NEXT
825 c.d=d(p+1)+22916:c.s=d(p)+22916:gosub 2200: 'CALL 26187,d(p+1)+22916,d(p)+22916
828 p=p+1
830 NEXT b,a
