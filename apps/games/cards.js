...
1760 scg=0
1770 GOSUB 1350
1780 FOR za=1 TO 2000:NEXT
1790 GOSUB 1470
1800 FOR za=1 TO 3000:NEXT   
1810 GOTO 2030
1820 kart1=INT(RND*eing)+1    
1830 IF k$(kart1)="" THEN 1820
1840 GOSUB 1350
1850 GOSUB 3010
1860 FOR za=1 TO 2000:NEXT
