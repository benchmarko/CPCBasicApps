...
290 if ge=3 then sp=1 else sp=40/ge :'sp=400/ge:IF ge=3 THEN sp=0
300 GOTO 410
...
690 FOR i=1 TO 3000/10:call &bd19:IF INKEY$<>"" THEN 720 ELSE NEXT i:GOTO 720
...
870 st=st+1
880 call &bd19:IF INKEY(76)=0 or inkey(9)=0 THEN s=s+1 
...
1220 GOSUB 1280:IF st=0 THEN 760 ELSE  1260: 'IF st<32765 THEN 1260
1250 st=1
1260 RETURN
1280 b1=b1+x-2
