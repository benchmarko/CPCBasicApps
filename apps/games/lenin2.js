...
1 rem lenin2 - Leningrad (Program)
2 rem (c) Sakis Kaffesakis, 2022
3 rem https://amstradsakis.blogspot.com/2022/04/battle-of-leningrad.html
4 REM LENINGRAD COPYRIGHT BY SAKIS KAFFESAKIS 2022 - MUSIC BY MANOSSG
5 SYMBOL AFTER 256:MEMORY &6FFF : SYMBOL AFTER n
6 GOSUB 3500
7 re=0:CP=0
...
365 IF CPP$<>"OFI" THEN GOSUB 9730:LOCATE 32,15:PRINT"WRONG PASSWORD!":dl=1000:gosub 12000:RETURN 
...
1000  REM ROOM 1
1010 MODE 1
1011 PEN 1:INK 0,0:INK 1,26:INK 2,13:INK 3,20:f$="lenin01.scr":gosub 13000:GOSUB 9030
1030 GOTO 1100
1089 GOSUB 1995
...
2000 REM ROOM 2
2010 MODE 1:
2011 PEN 2:INK 0,0:INK 1,3:INK 2,25:INK 3,15:f$="lenin02.scr":gosub 13000:GOSUB 9030
2030 GOTO 2100
2089 GOSUB 1995
...
3000 REM ROOM 3
3010 MODE 1:
3011 PEN 1:INK 0,0:INK 1,26:INK 2,15:INK 3,12:f$="lenin03.scr":gosub 13000:GOSUB 9030
3030 GOTO 3100
3090 GOSUB 1995
...
4000 REM ROOM 4
4010 MODE 1
4011 PEN 1:INK 0,0:INK 1,26:INK 2,13:INK 3,16:f$="lenin04.scr":gosub 13000:GOSUB 9030
4030 GOTO 4100
4090 GOSUB 1995
...
4990 dl=600:gosub 12000:LOCATE 2,24:PRINT SPC(24):RETURN
4999 END
5000 CLS:REM tank
...
5210 dl=1000:gosub 12000:SOUND 1,100,15,12,,,15:PEN 3:FOR V=0 TO 21:LOCATE 37-V,14:PRINT OV$:dl=20:gosub 12000:LOCATE 37-V,14:PRINT"    ":NEXT V:LOCATE 15,14:PRINT OV$
...
5760 dl=1000:gosub 12000:SOUND 1,100,15,12,,,15:GOSUB 9710:PEN 3:FOR V=0 TO 14:LOCATE 37-V,11:PRINT OV$:dl=50:gosub 12000:LOCATE 37-V,11:PRINT"    ":NEXT V:LOCATE 22,11:PRINT OV$
...
6000 REM ROOM 6
6009 SC6=SC6+1
6011 PEN 1:MODE 1:INK 0,0:INK 1,26:INK 2,10:INK 3,21:f$="lenin06.scr":gosub 13000:GOSUB 9030
6012 GOSUB 999
...
6990 dl=600:gosub 12000:LOCATE 2,24:PRINT SPC(25):RETURN
...
7013 f$="lenin07.scr":gosub 13000
7014 GOSUB 9030
7015 GOSUB 999
...
8800 REM END SCREEN
8804 GOSUB 9700
8805 BORDER 11:INK 0,0:MODE 1:INK 1,26:INK 2,13:INK 3,3:f$="lenin08.scr":gosub 13000:SONG$="MUSIC4.AKG":GOSUB 9500
8810 GOSUB 9030
