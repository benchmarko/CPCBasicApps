...
3 rem Modifications: renumbered lines to start with 4; comment in line 2019
4 INK 0,13:INK 1,0:h=207:w=440:v=54:p=45:q=75:g=24:g$=" GAME OVER":PRINT ""+chr$(13)+""+chr$(13)+"! CPCanabalt":b=&BC00:d=&BD00:r=MAX(r,t)
...
7 LOCATE 20,8+MAX(1,ABS(o-4)):PRINT " ":LOCATE 20,8+MAX(1,ABS(u-4)):PRINT CHR$(250+s):s=1-s:PRINT ""+chr$(13)+""t
...
10 IF (g=6 OR g=7) AND (u<1 OR u>7) THEN LOCATE 20,12:PRINT ""g$:INPUT"",a:GOTO 4 ELSE PRINT"A"r
11 IF p<7 THEN IF p>2 AND u=0 THEN FOR i=1 TO 6:LOCATE 20,11+i:PRINT " 
ú";:NEXT:PRINT "
"g$:INPUT"",a:GOTO 4
