...
9 IF n=0 THEN w=0:FOR i=1 TO LEN(a$):PLOT -2,-2,11:TAG:MOVE f+(4*w),g:PRINT MID$(a$,i,1);:w=w+4: TAGOFF:NEXT i:RETURN ELSE IF n=1 THEN FOR i=1 TO 100:i=i:NEXT:RETURN ELSE IF q=t AND p=20 THEN INK b,d(o),d(o+4):RETURN ELSE RETURN
...
290 IF n=0 THEN w=0:FOR i=1 TO LEN(a$):PLOT -2,-2,11:TAG:MOVE f+(4*w),g:PRINT MID$(a$,i,1);:w=w+4:TAGOFF:NEXT i:RETURN ELSE IF n=1 THEN FOR i=1 TO 100:i=i:NEXT:RETURN ELSE IF q=t AND p=20 THEN INK b,d(o),d(o+4):RETURN ELSE RETURN
