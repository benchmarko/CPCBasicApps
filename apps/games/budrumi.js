...
286 dl=1000:gosub 12000:GOSUB 9720
...
536 LOCATE 2,18:PRINT "1. ";ROOM1$:LOCATE 2,20:PRINT "2. ";ROOM2$:LOCATE 2,22:PRINT "3. ";ROOM3$:LOCATE 2,24:PRINT "4. ";ROOM4$ 
540 REM
541 LOCATE 5,5
550 R$=INKEY$
...
999 RETURN
1000 REM ROOM 1
1010 MODE 1:INK 0,0:INK 1,13:INK 2,16:INK 3,12:f$="budrumi1.scr":gosub 13000:
1020 ROOM1$="BEDROOM"
1025 SC1=SC1+1
...
1155 IF T$="4" AND OBJ$<>"CANDLE" THEN LOCATE 2,25:PRINT"Nothing happens":GOSUB 9730:dl=1000:gosub 12000:LOCATE 2,25:PRINT SPC(16):GOTO 1100
...
1999 INK 1,26:END
2000 REM ROOM 2
2010 MODE 1:INK 0,0:INK 1,13:INK 2,16:INK 3,14:f$="budrumi2.scr":gosub 13000
2020 ROOM2$="LIBRARY"
2025 SC2=SC2+1
...
2109 CLEAR INPUT
2110 T$=INKEY$ 
2120 IF T$="1" THEN LOCATE 2,25:PRINT"Can't read-its dark":GOSUB 9730:dl=1000:gosub 12000:LOCATE 2,25:PRINT SPC(19):GOTO 2100
2130 IF T$="2" THEN OBJ$="BALD ROPE":GOSUB 9030:GOTO 2100
2140 IF T$="3" THEN OBJ$="CANDLE":GOSUB 9030:GOTO 2100
2150 IF T$="4" AND OBJ$<>"MATCHES" THEN LOCATE 2,25:PRINT"Nothing happens":GOSUB 9730:dl=1000:gosub 12000:LOCATE 2,25:PRINT SPC(16):GOTO 2100
...
2999 END
3000 REM ROOM 3
3010 MODE 1:INK 0,0:INK 1,13:INK 2,12:INK 3,16:f$="budrumi3.scr":gosub 13000
3020 ROOM3$="DINING R."
3025 SC3=SC3+1
...
3150 IF T$="4" THEN LOCATE 2,25:PRINT"Nothing happens":GOSUB 9730:dl=1000:gosub 12000:LOCATE 2,25:PRINT SPC(16):GOTO 3100 
...
3999 END
4000 REM ROOM 4
4010 MODE 1:INK 0,0:INK 1,13:INK 2,16:INK 3,26:f$="budrumi4.scr":gosub 13000
4020 ROOM4$="LIVING R."
4025 SC4=SC4+1 
...
4135 IF T$="2" AND chest=0 AND OBJ$<>"CHEST KEY" THEN LOCATE 2,25:PRINT"Chest is locked":GOSUB 9730:dl=1000:gosub 12000:LOCATE 2,25:PRINT SPC(16):GOTO 4100
4140 IF T$="2" AND chest=0 AND OBJ$="CHEST KEY" AND DR=0 THEN GOTO 9230
4145 IF T$="4" THEN LOCATE 2,25:PRINT"Nothing happens":GOSUB 9730:dl=1000:gosub 12000:LOCATE 2,25:PRINT SPC(16):GOTO 4100  
...
4157 IF T$="5" AND chest=1 AND (obj$<>"DOOR KEY" OR OBJ$<>"AXE") THEN LOCATE 2,25:PRINT"Door is locked":GOSUB 9730:dl=1000:gosub 12000:LOCATE 2,25:PRINT SPC(16):GOTO 4100
...
5010 MODE 1:INK 0,0:INK 1,13:INK 2,14:INK 3,25:f$="budrumi5.scr":gosub 13000:
...
6010 MODE 1:INK 0,0:INK 1,13:INK 2,16:INK 3,14:f$="budrumi6.scr":gosub 13000
...
6999 END
7000 REM ROOM7
7010 MODE 1:INK 0,0:INK 1,13:INK 2,25:INK 3,16:f$="budrumi7.scr":gosub 13000
7017 SC7=SC7+1
...
8802 GOSUB 490
8804 GOSUB 9700
8805 MODE 1:INK 0,0:INK 1,13:INK 2,20:INK 3,25:f$="budrumi8.scr":gosub 13000 
...
8850 dl=2000:gosub 12000:LOCATE 16,25:PRINT"GAME OVER"
8997 GOSUB 490
...
9520 sfx=&9000
9530 player=&9500
9535 poke player,&c9:poke player+3,&c9:poke player+6,&c9:poke player+9,&c9:goto 9570:' no music for CPCBasic
...
13020 resume 13030
13030 openin "!budrumis.zip":closein:'cpcBasic: extract screens from archive
