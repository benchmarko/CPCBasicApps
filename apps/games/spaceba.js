...
650 WHILE SH>-1:MODE 0:PAPER 3:CLS:PEN 2:LOCATE 7,13:PRINT"LEVEL";LV;:FOR Z=1 TO 5000:NEXT:MODE 1:PAPER 0:CLS:LZ=40:LZ1=0:LZ2=0:LZC=1:HT=0:ERASE A,B:DIM A(5),B(5)
...
1070 SOUND 1,0,15,5,0,0,5:FOR Z=0 TO 24 STEP 6:INK 1,Z:INK 2,Z+2:INK 3,Z/6:FOR Z1=1 TO 30:NEXT Z1,Z:INK 2,2:INK 3,6:MOVE SH*2,16:DRAW SH*2,30,0:SH%=SH%-1:B(X)=0:PEN 2:GOSUB 1220:RETURN
