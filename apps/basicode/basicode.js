...
10 GOTO 1000:REM BASICODE-3 SUBS V4.1 19-2 '89 (C) S.Simons, M.van der Meer
20 CLS:CLEAR:IF PEEK(&AE64)=&6F THEN SCRMODE=&B7C3 ELSE SCRMODE=&B1C8
21 IF PEEK(SCRMODE)=0 OR PEEK(SCRMODE)=2 THEN MODE 1
22 IF PEEK(SCRMODE)=1 THEN HO=39:VE=24:HG=270:VG=200:WINDOW #1,1,40,25,25
24 SV=7:OG=0:reading=&9E3F:writing=&9E00:GOTO 1010
100 CLS:RETURN
...
425 WHILE (SQ(1) AND 128):WEND:RETURN
430 RETURN
450 OTIME=TIME
451 OSD=SD*30
...
950 CLS:CLEAR:END
1000 'MEMORY &9200-1:LOAD"!bc3bin.bin":CALL &A585:|HELP
1010 rem hex &170-&196: 27 00 00 00 C5 20 20 37 20 CD 60 BB 32 77 01 C9 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 00
*/ });
