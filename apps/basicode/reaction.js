...
1230 PRINT"Druecke Z, W oder A";:GOSUB 210
...
3090 REM ---2 LETTERS---
3100 GOSUB 260:X=AA+INT(RV*26):X$=CHR$(X):IF K2=2 THEN 3510
3110 REM ---2 LETTERS ---
...
3560 GP=GP+PH:IF GP>=1-PH THEN 950
3570 REM ---DOE DE FLITS---
3580 Z$="":FOR N=1 TO LEN(X$):Q$=MID$(X$,N,1)
3590 IF Q$="0" THEN Q$="O"
3600 Z$=Z$+Q$:NEXT N:REM ---0 WORDT O---
3610 HO=.4:VE=.29:SR$=Z$:GOSUB 650
3620 GOSUB 400:REM >> FLITSDUUR <<
3630 CN=1:GOSUB 650:CN=0
3640 HO=.37:VE=.6:SR$="?":GOSUB 650
3650 REM ---INPUT ANTWOORD---
3660 Y$="":LY=0:HO=.4:VE=.6
3670 GOSUB 210:IF IN=13 THEN 3780
3680 IF IN$="!" THEN GOSUB 100:GOTO 1180
3690 IF (IN<33) OR (IN>127) THEN 3670
3700 IF (IN=127) AND (LY=0) THEN 3670
3710 IF IN<>127 THEN 3760
3720 CN=1:SR$=Y$:GOSUB 650:CN=0
3730 IF LEN(Y$)=1 THEN Y$="":GOTO 3750
...
25320 REM
32000 REM GESCHRIEBEN AUF BBC-COMPUTER
32010 REM JANUAR 1989
