...
1000 A=200:GOTO 20:REM LANDEN EN HOOFDSTEDEN
1010 GOSUB 100:N=178:REM N=AANTAL LANDEN+STEDEN
1020 HT=HO:REM SCHERMBREEDTE
1030 REM +++BEGINSCHERM++++
1040 VE=3:HO=INT (HT/2-8):GOSUB 110
1050 SR$="178 LANDEN":GOSUB 150
1060 VE=5:HO=INT (HT/2-10):GOSUB 110
1070 SR$="EN HOOFDSTEDEN":GOSUB 150
1080 VE=7:HO=INT (HT/2-19):GOSUB 110
1090 SR$="VAN AFGHANISTAN TOT ZWITSERLAND":GOSUB 150
1100 VE=15:HO=0:GOSUB 110
1110 REM +++UITLEG+++
1120 PRINT "Wilt U uitleg (j/n) ?";
1130 GOSUB 210
1140 IF IN=78 THEN GOTO 2010:REM N
1150 IF IN<> 74 THEN GOTO 1130:REM J
1160 GOSUB 100
1170 PRINT "Dit programma geeft van 178 LANDEN"
1180 PRINT "de HOOFDSTEDEN,de oppervlakte"
1190 PRINT "en het aantal inwoners.":PRINT 
1200 PRINT "Er zijn DRIE mogelijkheden.":PRINT 
1210 PRINT "1. Intypen van een LAND en"
1220 PRINT "   zoeken naar de HOOFDSTAD.":PRINT 
1230 PRINT "2. Intypen van een HOOFDSTAD"
1240 PRINT "   en zoeken naar het LAND.":PRINT 
1250 PRINT "3. Opvragen van alle LANDEN."
1260 PRINT "   en HOOFDSTEDEN."
1270 GOSUB 6010
2000 REM +++MENU+++
2010 GOSUB 100:SR$="MENU"
2020 VE=0:HO=7:GOSUB 110:GOSUB 150
2030 VE=1:HO=0:GOSUB 110
2040 PRINT :PRINT " 1. Zoeken HOOFDSTAD."
2050 PRINT :PRINT " 2. Zoeken LAND."
2060 PRINT :PRINT " 3. Overzicht LANDEN"
2070 PRINT "    en HOOFDSTEDEN."
2080 PRINT :PRINT " 4. Stoppen."
2090 VE=16:HO=0:GOSUB 110
2100 SR$="Maak uw keuze 1-4":GOSUB 150
2110 GOSUB 210
2120 IF (IN<49) OR (IN>52) THEN GOTO 2110
2130 ON IN-48 GOTO 3010,4010,5010,950
3000 REM +++HOOFDSTAD ZOEKEN+++
3010 GOSUB 100
3020 PRINT "Tik de naam van het land in."
3030 PRINT "Minstens de VIER eerste letters."
3040 PRINT :PRINT "En druk op de <ENTER> of <RETURN> toets"
3050 PRINT :PRINT "LAND:";
3060 INPUT Y$:IF LEN (Y$)<4 THEN GOTO 3060
3070 SR$=LEFT$(Y$,4):GOSUB 330:Y$=SR$
3080 GOSUB 100
3090 PRINT "Even geduld A.U.B."
3100 RESTORE :I=0
3110 READ L$,H$,PO$,LI$,HI$
3120 IF Y$=LEFT$(L$,4) THEN GOTO 3170
3130 I=I+1:IF I<N+1 THEN GOTO 3110
3140 GOSUB 100:PRINT "Er komt geen LAND (meer) voor met"
3150 PRINT :PRINT "de letters: ";Y$;" in het bestand."
3160 GOTO 1270
3170 GOSUB 100
3180 PRINT "LAND:":PRINT 
3190 PRINT L$:PRINT :PRINT "Oppervlakte ";PO$;" km2"
3200 PRINT :PRINT "Inwonertal in 19";LI$
3210 PRINT :PRINT :PRINT "HOOFDSTAD:"
3220 PRINT :PRINT H$:PRINT :PRINT "Inwonertal in 19";HI$
3230 GOSUB 6010
3240 READ L$,H$,PO$,LI$,HI$
3250 IF Y$=LEFT$(L$,4) THEN GOTO 3170
3260 GOTO 3140
4000 REM +++LAND ZOEKEN+++
4010 GOSUB 100
4020 PRINT "Tik de naam van de hoofdstad in."
4030 PRINT "Minstens de VIER eerste letters."
4040 PRINT :PRINT "En druk op de <ENTER> of <RETURN> toets"
4050 PRINT :PRINT "HOOFDSTAD:";
4060 INPUT Z$:IF LEN (Z$)<4 THEN GOTO 4060
4070 SR$=LEFT$(Z$,4):GOSUB 330:Z$=SR$
4080 GOSUB 100
4090 PRINT "Even geduld A.U.B."
4100 RESTORE :I=0
4110 READ L$,H$,PO$,LI$,HI$
4120 IF Z$=LEFT$(H$,4) THEN GOTO 4180
4130 I=I+1:IF I<N+1 THEN GOTO 4110
4140 GOSUB 100
4150 PRINT "Er komt geen HOOFDSTAD (meer) voor"
4160 PRINT :PRINT "met de letters: ";Z$;" in dit bestand."
4170 GOTO 1270
4180 I=I+1:GOSUB 100
4190 PRINT "LAND:":PRINT 
4200 PRINT L$:PRINT :PRINT "Oppervlakte ";PO$;" km2"
4210 PRINT :PRINT "Inwonertal in 19";LI$
4220 PRINT :PRINT :PRINT "HOOFDSTAD:"
4230 PRINT :PRINT H$:PRINT :PRINT "Inwonertal in 19";HI$
4240 GOSUB 6010
4250 IF I<N+1 THEN GOTO 4110
4260 GOTO 1270
...
5050 A=38-LEN (L$+H$)
5060 W$=LEFT$("......................................",A)
5070 PRINT L$;W$;H$:PRINT 
5080 GOSUB 120:IF VE<21 THEN GOTO 5100
5090 GOSUB 6010:GOSUB 100
5100 NEXT I:GOTO 1270
6000 REM +++DRUK OP EEN TOETS+++
6010 VE=22:HO=0:GOSUB 110
6020 SR$="<Druk op een toets.>"
6030 GOSUB 150:GOSUB 210:RETURN 
