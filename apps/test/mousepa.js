...
60 '
70 d=d+1:d=d mod 3:locate #1,1,1:print#1,d$(d); 'switch drawing mode
80 '
90 x0=xpos:y0=ypos
100 locate #1,5,1:print#1,x0;y0;chr$(18); 'show coordinates
110 move 1000,1000 'activate move on mouse click
120 '
130 call &bd19
135 t$=inkey$:if t$<>"" then print t$; 'side effect: click on text
