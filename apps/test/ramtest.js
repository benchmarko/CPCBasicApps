...
2 rem mv
10 mode 2
30 print"Standard RAM bank:":print hex$(&7fc0)
40 mem=64
50 print"Additional RAM banks found:"
60 wrt=1:gosub 200
65 out &7fc0,&c0:poke &4000,&c0:poke &4001,&7f
70 wrt=0:gosub 200
80 print:print"Total:";str$(mem);" KB RAM found"
90 goto 300
100 '
200 for hi=&78 to &7f
210 for lo=&c4 to &ff
...
240 if peek(&4000)=lo and peek(&4001)=hi then mem=mem+16:print hex$(hi*256+lo);" ";
